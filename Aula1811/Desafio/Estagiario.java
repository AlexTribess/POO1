...
public class Estagiario extends Funcionario implements IPagamento {

    TipoFuncionario tipo = TipoFuncionario.GERENTE;

    public Estagiario(double salLiquido, double salarioBruto, double descontos) {
    ...
    public String toString() {
        final StringBuffer sb = new StringBuffer("Estagiario{");

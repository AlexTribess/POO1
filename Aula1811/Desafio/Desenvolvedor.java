...
public class Desenvolvedor extends Funcionario implements IPagamento {

    TipoFuncionario tipo = TipoFuncionario.GERENTE;

    public Desenvolvedor(double salLiquido, double salarioBruto, double descontos) {
